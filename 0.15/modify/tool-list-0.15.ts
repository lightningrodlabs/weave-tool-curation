...
export default defineDevCollectiveToolList({
    ...
    },
  {
    ...
    },
    {
      ...
      description: "Import of scraped tool data, claiming of imported tools, creating new tools, tool search, activity feed, and profiles.",
    ...
    },
    {
      ...
      description: "The game focuses on making space for every player to contribute to the play, and encourages deep listening for collaborative meaning making.  It's also really fun.\n\nThis incarnation of the Glass Bead Game was developed originally by James and Gnoman for [weco.io](https://www.weco.io/s/all/about).",
