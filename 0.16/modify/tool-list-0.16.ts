  ...
  tools: [
    ...
    },
    {
      ...
      versions: [
        {
          version: "0.18.0",
          url: "https://github.com/holochain-apps/kando/releases/download/v0.18.0/kando.webhapp",
          hashes: {
            happSha256:
              "f29edf473aed3d4f659f135bf95735c99c6e7b3484730400cc64e97fe2a5199a",
            webhappSha256: "81661ef9582eba015e2cbb7f96953ff73786fe9dfec4b6e450abcafa3cce12d2",
            uiSha256: "a47112ef4a195f83622d001937ebd0c8f973eb3496d71fbacf0168f084844b9c",
          },
          changelog: "First release of the Holochain 0.7 line, for Moss 0.16. New network: 0.18.x agents cannot see boards from any 0.17.x version, so groups should upgrade together. Use Settings \u2192 Export All Boards / Import Boards to carry boards across.",
          releasedAt: 1788812120000,
        },
      ],
    },
    {
      ...
      versions: [
        {
          version: "0.16.0",
          url: "https://github.com/holochain-apps/talking-stickies/releases/download/v0.16.0/talking-stickies.webhapp",
          hashes: {
            happSha256:
              "54b29d444ac5dbccd810c0680fe00db89c98757e09d0a639aeaa0bcd67c8f00a",
            webhappSha256: "1dcfd725ffd5637ec0757d6d761a8f540bc718c8eea9893ed1ee79cd3cbdd201",
            uiSha256: "cb8f7d2d3ab59c64eb3901db29b3858333c96d0a69419c96e0302336410b0ed7",
          },
          changelog: "First release of the Holochain 0.7 line, for Moss 0.16. New network: 0.16.x agents cannot see boards or stickies from any 0.15.x version, so groups should upgrade together. Use the board menu\u2019s Export and the About dialog\u2019s Import to carry boards across. Also fixes Moss search, which threw on every query on the 0.15.x line.",
          releasedAt: 1788812986000,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      versions: [
        {
          version: "0.11.0",
          url: "https://github.com/lightningrodlabs/tables/releases/download/v0.11.0/tables.webhapp",
          hashes: {
            happSha256:
              "8c4e9a5d29eb3f59cd0a93a8f40c7a64fafe61a56a505eae623c9a99027e6840",
            webhappSha256: "b56d11256ab4153b815e347aa4e9afc40ded765b714385cbebbe4e1b56507322",
            uiSha256: "82bcbf49fcd47c42ad122b934ff6a9fd502355cb9b9c49a60e6817ca5438a5a9",
          },
          changelog: "First release of the Holochain 0.7 line, for Moss 0.16. New network: 0.11.x agents cannot see tables from any 0.10.x version, so groups should upgrade together. Use a board\u2019s \u22ef menu \u2192 Export, and Import on the 0.11.x side, to carry data across.",
          releasedAt: 1788904771000,
        },
      ],
    },
    {
      ...
      versions: [
        {
          version: "0.4.0",
          url: "https://github.com/lightningrodlabs/glass-bead-game/releases/download/v0.4.0/glassbeadgame.webhapp",
          hashes: {
            happSha256:
              "45999d1a812c7de718f49a974fe667ca1d8ca1d8599cc4e468b0fdc85faeac68",
            webhappSha256: "33086a5b7a48ce71970b40047646a97c1251e1665918df3a60d31e5dbe0224a9",
            uiSha256: "d0eb769a34d822f22d4fff73355aeb13edabe4a72e0ca58625822b4bdaf7f0af",
          },
          changelog: "First release of the Holochain 0.7 line, for Moss 0.16. New network: 0.4.x agents cannot see games from any 0.3.x version, so groups should upgrade together.",
          releasedAt: 1788905178000,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      versions: [
        {
          version: "13.0.0",
          url: "https://github.com/lightningrodlabs/acorn/releases/download/v13.0.0/acorn.webhapp",
          hashes: {
            happSha256:
              "5efe3ec814c8bbd70cfcaef07819749c5aa5fe1f9e7e67e5ca09b47dfbb3901d",
            webhappSha256: "49cd1e4eeb62c0ca2f5baa6960847c61cd2e35bc662c6851430b76f6de703302",
            uiSha256: "7140b7a82b717fe53e98b042fe8609977bf090ee462169cb942ad1ac5c878098",
          },
          changelog: "First release of the Holochain 0.7 line, for Moss 0.16. New network: 13.0.x agents cannot see projects from any 12.x version, so groups should upgrade together, and projects do not carry across by themselves -- export projects in 12.x and import them into 13.0. This release also keeps edits and presence live between teammates without a reload, makes entry points reliable to set and clear while editing a card, lets you edit and delete your own comments, keeps the newest comment in view, and makes \"Switch to\" in a card's asset view open that card in Acorn.",
          releasedAt: 1789160648000,
        },
      ],
    },
  ],
