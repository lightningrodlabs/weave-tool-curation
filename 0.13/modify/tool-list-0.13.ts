  ...
  tools: [
    ...
    },
    {
      ...
      versions: [
        {
          version: "1.15.0",
          url: "https://github.com/lightningrodlabs/vines/releases/download/we-applet-rc/vines-we_applet-1.15.0.webhapp",
          hashes: {
            happSha256:
              "7b593486d04236b2d63b36b5ee73a9fb62e2abc653305b403c647c491756fd5a",
            webhappSha256:
              "47abdb59cd5d57ca7e64ac5d6863d6a78232e7a8592ddf7a63f1eb66d3cb45d0",
            uiSha256:
              "4d6c71ac83739bcf87e7847d571970ea3cd684bbebe87cfac3cd2a83a4bbc443",
          },
          changelog:
            "Added send button. Renamed Topic to category and added default category. Tool button at bottom of side bar. Fixed DM input.",
          releasedAt: 1743627343000,
        },
      ],
    },
    {
...
- 🎈 Fix: Resolved issue where presets would disappear from game library if games were created directly from there
        ...
        },
        {
          ...
          url: "https://github.com/holochain-apps/gamez/releases/download/UI-v0.8.4/gamez.webhapp",
          changelog: `
        ...
        },
        {
          ...
          hashes: {
            happSha256:
              "6335eca61415e769c22934d354614e581e65eb4728be0eff2f447c3d729c1f6d",
            webhappSha256:
              "1cf0a043f4f0f508df984b80b56f48d3638c0b2ccfb50035950bc67f43aa8442",
            uiSha256:
              "8a04024af181dc4e6e225c08ab4ae98f1431495d61484fc19b03b8bf9c35d04c",
          },
          url: "https://github.com/holochain-apps/gamez/releases/download/UI-v0.8.3/gamez.webhapp",
          changelog: `
  ...
  - Added hand tool you can pick to pan with left click (and panning also linked to wheel click from any tool)`,
    ...
    },
    {
      ...
      versions: [
        ...
        {
          version: "0.10.5",
          url: "https://github.com/lightningrodlabs/converge/releases/download/0.1.2/converge.webhapp",
          hashes: {
              happSha256: "81f5ad2313f163a0a77c6e6829eb08370ad5723214e742e30ad885da000e85ca",
              webhappSha256: "674607fab5033fc68ed4570a3b7cfd8754c05e7524c9b18ada219f54826d2127",
              uiSha256: "3af3b6ab9e2846861de3c73f4510d359de93a4d160dfe97dc61b5c5a6416bf30"
          },
          changelog: "UX improvements",
          releasedAt: 1744898000000
        }
      ],
    },
    {
      ...
      versions: [
        ...
        {
          version: "0.1.3",
          url: "https://github.com/lightningrodlabs/whos-in/releases/download/0.1.2/whosin-0.1.2-b.webhapp",
          hashes: {
            "happSha256": "3d360afe752960a6b45931310f0e9ffc604dd4b977a63c9bd7db6ce2b555269a",
            "webhappSha256": "1f47644bd995bfe9150b97d6bf70628d7df7b70ff0eaafc9b99f95511d6e335e",
            "uiSha256": "60996ccc07fdf4309247b30079c5565dc5eda02aca3600eb55f5f52845f7ea07"
        },
          changelog: "Fixed a bug that prevented event creation in Moss",
          releasedAt: 1745082843252
        },
      ]
    }
  ],
